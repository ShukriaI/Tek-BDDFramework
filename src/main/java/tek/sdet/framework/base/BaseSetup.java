...
public class BaseSetup {
    ...
    // this class is parent class of all step definitions Utilities class and POM classes
	...
	public BaseSetup() {
       ...
       try {
		 ...
		 System.out.println("Failed for Load environment conext. check posssible file path error");
		e.printStackTrace();
		throw new RuntimeException("Failed for Load environmet contex with message"+e.getMessage());
	}
	...
	public void setUpBrowser() {
		...
		case "edge":
          ...
          break;
          default:
        	  throw new RuntimeException("unknown browser environment properties");
		}
